...
exports.addMedicine = async (req, res) => {
  try {
    ...
    await contract.methods.addMedicine(medicineID, name, manufacturer, expiryTimestamp, count).send({ from: '0x30C345364a73e02F350C64ddD87884b8E39374B3' }); // Update with your wallet address
